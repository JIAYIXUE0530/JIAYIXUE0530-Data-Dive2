...
import CompetitorDatabaseComponent from '../components/CompetitorDatabase'
    ...
    <div className="h-screen bg-[var(--bg-primary)] flex flex-col">
        ...
        <div className="w-full px-16">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="flex items-center gap-8">
              ...
              <Link to="/competitor-database" className="text-sm text-[var(--accent-forest)]">竞品数据库</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-auto">
        <div className="w-full h-full px-16 py-8">
          <div className="mb-8">
            <h2 className="font-display text-3xl lg:text-4xl font-light text-[var(--text-primary)] mb-2">竞品数据库</h2>
            <p className="text-[var(--text-secondary)]">查询和管理竞品销量数据，支持多维度筛选。</p>
          </div>

          <CompetitorDatabaseComponent />
        </div>
      </main>
