...
ANCHOR_DATE = datetime(2025, 12, 18)
...
def generate_report(file_path, anchor_date, output_path=None):
    ...
    report = {
        ...
        "summary": {
            "overall": f"截止2025年12月18日，累计销量达{total_sales:,}件（{total_sales/10000:.0f}万单），环比变化{mom_change:+.1f}%。TOP3品牌：{', '.join(top_brands)}。",
    ...
    if output_path is None:
        output_path = 'outputs/reports/report-2025-12-18.json'
