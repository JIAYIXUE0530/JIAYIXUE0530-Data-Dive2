          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {navItems.map((item, index) => (
              <Link
                ...
                className="group"
              >
                <div className="h-full bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-2xl p-8 transition-all duration-300 hover:shadow-xl hover:shadow-[var(--accent-forest)]/10 hover:border-[var(--accent-forest)]/30 hover:-translate-y-1">
                  <div className="flex flex-col h-full">
                    ...
                    <h3 className="font-display text-xl text-[var(--text-primary)] mb-3 group-hover:text-[var(--accent-forest)] transition-colors">
                      {item.title}
                    </h3>
                    ...
                    <div className="mt-6 flex items-center text-[var(--accent-forest)] opacity-0 group-hover:opacity-100 transition-opacity">
